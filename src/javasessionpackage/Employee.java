...
//		new Employee().name="Naveen";// these will be no reference objects
//		new Employee().salary=12.33; // this is bad practice to create objects
//		System.gc(); // system will call gc
